            ...
            <div class="card" style="background-color: transparent; border: 1px solid blue">
                <div class="card-body">
                    <form method="POST" action="{{ route('register') }}">
                        ...
                        <div class="row mb-3">
                            <label for="nombre" class="col-md-4 col-form-label text-md-end" style="color: white">{{ __('Nombre') }}</label>
                        ...
                        <div class="row mb-3">
                            <label for="password-confirm" class="col-md-4 col-form-label text-md-end" style="color: white">{{ __('Confirmar contrasena') }}</label>
                        ...
                        <div class="row mb-0">
                            <div class="col-md-10 offset-md-2">
                                ...
                                <span style="color: white">Ya tienes cuenta?</span><a href="{{ route('login') }}">{{ __(' Inicia sesion') }}</a>
                            </div>
                        </div>
                    </form>
                </div>
